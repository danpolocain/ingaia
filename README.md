...
This is a sample template for ingaia-weather-api - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name ingaia-weather-api --tail
```
...
```bash
aws cloudformation delete-stack --stack-name ingaia-weather-api
```
